  ...
  <div class="loginContainer">
    <head-top :head-title="loginWay? '登录':'密码登录'" goBack="true">
      <!-- <div
        ...
        class="change_login"
        slot="changeLogin"
      >{{loginWay? "密码登录":"短信登录"}}</div>-->
    </head-top>

    <form class="loginForm" v-if="loginWay">
      <!-- <section class="input_container phone_number">
        <input maxlength="11" name="phone" placeholder="账号密码随便输入" type="text" v-model="phoneNumber" />
        <button
      ...
      <section class="input_container">
        <input maxlength="6" name="mobileCode" placeholder="验证码" type="text" v-model="mobileCode" />
      </section>-->
    </form>

    <form class="loginForm" v-else>
      <section class="input_container">
        <input placeholder="账号" type="text" v-model.lazy="userAccount" />
      </section>
      <section class="input_container">
        <input placeholder="密码" type="password" v-if="!showPassword" v-model="passWord" />
        <input placeholder="密码" type="text" v-else v-model="passWord" />
        <div :class="{change_to_text: showPassword}" class="button_switch">
          <div
      ...
      <section class="input_container captcha_code_container">
        <input maxlength="4" placeholder="验证码" type="text" v-model="codeNumber" />
