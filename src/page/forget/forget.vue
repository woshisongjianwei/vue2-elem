<template>
  <div class="restContainer">
    <head-top goBack="true" head-title="重置密码"></head-top>
    <form class="restForm">
      ...
      <section class="input_container">
        <input name="oldPassWord" placeholder="旧密码" type="text" v-model="oldPassWord" />
      </section>
      <section class="tinput_container">
        <input name="newPassWord" placeholder="请输入新密码" type="text" v-model="newPassWord" />
      </section>
      <section class="input_container">
        <input name="confirmPassWord" placeholder="请确认密码" type="text" v-model="confirmPassWord" />
      </section>
    ...
    <div @click="resetButton" class="login_container">确认修改</div>
